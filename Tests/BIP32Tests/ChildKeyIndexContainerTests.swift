...
final class ChildKeyIndexContainerTests: XCTestCase {
    private func sut(index: UInt32, shouldHarden: Bool) throws -> ChildKeyIndexContainer {
...
// MARK: - Helpers
extension ChildKeyIndexContainerTests {
